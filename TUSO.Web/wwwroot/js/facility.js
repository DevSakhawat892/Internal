    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                var table = ['' + (i + 1) + '', '' + res[i].districts.districtName + '', '' + res[i].facilityName + ''];
                var data = { 'sl': (i + 1), 'oid': res[i].oid, 'facilityName': res[i].facilityName, 'districtID': res[i].districtID };
                    ...
                    { title: 'facility' },                                       
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (                             
                                ...
                                '<a href="javascript:;" class="dropdown-item delete-record" id="btnDelete" asp-action="Delete" asp-controller="Facility" asp-route-OID="@Model.OID">' +
