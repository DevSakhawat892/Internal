...
function ReadRouteTypes() {
    var tablearray = [];
    dataarray = [];
    $.ajax({
        url: baseapi + "route-types",
        type: "GET",
        dataType: "json",
        ...
        success: function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                var table = ['' + (i + 1) + '', '' + res[i].routeTypeName + ''];
                var data = { 'sl': (i + 1), 'oid': res[i].oid, 'routeTypeName': res[i].routeTypeName };
...
$('body').on('click', '#btnEdit', function () {
    ...
    $('#OID').val(dta.oid);
    $('#routeTypeName').val(dta.routeTypeName);
