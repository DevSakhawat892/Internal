    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                ...
                var table = ['' + (i + 1) + '', '' + res[i].departmentName + '', '' + res[i].description + ''];
                var data = { 'sl': (i + 1), 'oid': res[i].oid, 'departmentName': res[i].departmentName, 'description': res[i].description };
...
$('body').on('click', '#btnEdit', function () {
    ...
    $('#OID').val(dta.oid);
    $('#departmentName').val(dta.departmentName);
