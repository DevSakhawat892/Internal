...
var baseUrl = "https://localhost:7185/Country/";
var dataarray = [];
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            for (var i = 0; i < res.length; i++) {
                var table = ['' + (i + 1) + '', '' + res[i].countryName];
                var data = { 'sl': (i + 1), 'oid': res[i].oid, 'countryName': res[i].countryName};
                    ...
                    { title: 'country name' },
                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                'Details</a>' +
                                '<a href="javascript:;" class="dropdown-item delete-record" id="btnDelete"  asp-action="Delete" asp-controller="Country">' +
                                feather.icons['trash-2'].toSvg({ class: 'me-50 font-small-4' }) +
                                'Delete</a>' +
                                '</div>' +
                                '</div>' +
...
$('body').on('click', '#btnEdit', function () {
    ...
    $('#OID').val(dta.oid);
    $('#countryName').val(dta.countryName);
